...
contract TicketFactory {
    ...
    event WithdrawBNBFactory(address Controller, uint256 amount, address receiver, uint256 time);
    ...
    function createID(uint256 _regId, address _eventAdmin) external onlyController {
        ...
        function withdraw(uint256 _amount, address _to) external onlyController {
            ...
            emit WithdrawBNBFactory(msg.sender, _amount, _to, block.timestamp);
        }
